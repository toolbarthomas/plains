...
class ConfigLoader {
  constructor(config) {
     ...
     * configuration.
     */
    this.defaultConfiguration = load(resolve(__dirname, '../plains.default.config.js'));
     ...
     */
    this.customConfiguration = load('plains.config.js') || {};

    /**
     * Stores the application configuration that has been defined while creating
     * a new config instance.
     */
    this.inlineConfiguration = config instanceof Object ? config : {};
  ...
  define() {
    ...
    this.config = this.validate(
      ...
      Object.assign(this.customConfiguration, this.inlineConfiguration)
    );
    ...
    if (defaults && config && defaults.constructor === config.constructor) {
      if (!(defaults instanceof Array) && defaults instanceof Object && config instanceof Object) {
        ...
        Object.keys(defaults).forEach(name => {
          ...
          if (name === 'workers') {
            mergedConfig[name] = Object.assign(defaults[name], config[name]);
