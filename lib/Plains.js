...
const Synchronizer = require('./Workers/Synchronizer');
...
class Plains {
  ...
  boot() {
    ...
    // Enables static file sync.
    this.assignWorker('Synchronizer', Synchronizer);

    // Resolves external dependencies.
    this.assignWorker('VendorResolver', VendorResolver);
